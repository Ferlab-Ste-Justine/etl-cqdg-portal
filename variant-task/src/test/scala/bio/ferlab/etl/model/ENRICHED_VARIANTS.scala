/** Generated by [[bio.ferlab.datalake.testutils.ClassGenerator]] on 2023-10-20T11:51:34.299391
  */
package bio.ferlab.etl.model

case class ENRICHED_VARIANTS(
    `chromosome`: String = "1",
    `start`: Long = 14464,
    `reference`: String = "A",
    `alternate`: String = "T",
...
case class THOUSAND_GENOMES(`ac`: Option[Long] = None, `af`: Option[Double] = None, `an`: Option[Long] = None)

case class ORPHANET(
    `disorder_id`: Option[Long] = None,
...
case class EXTERNAL_FREQUENCIES(
...
case class GNOMAD(`pli`: Option[Float] = None, `loeuf`: Option[Float] = None)

case class GNOMAD_GENOMES_2_1_1(
    `ac`: Option[Long] = None,
...
case class CMC(
    `mutation_url`: Option[String] = None,
...
case class HPO(
    `hpo_term_id`: Option[String] = None,
    `hpo_term_name`: Option[String] = None,
    `hpo_term_label`: Option[String] = None
)

case class STUDY(`study_id`: String = "S1", `study_code`: String = "study_code1", `zygosity`: Set[String] = Set("HET"))

case class STUDY_FREQUENCIES_WGS(
    `study_id`: String = "S1",
    `total`: TOTAL = TOTAL(),
    `study_code`: String = "study_code1",
    `transmission`: Set[String] = Set("autosomal_dominant")
)
case class STUDY_FREQUENCIES_WGS_WITHOUT_TRANSMISSION(
    `study_id`: String = "S1",
    `total`: TOTAL = TOTAL(),
    `study_code`: String = "study_code1"
)

case class SPLICEAI(`ds`: Option[Double] = None, `type`: Option[Seq[String]] = None)

case class TOPMED_BRAVO(
    `ac`: Option[Long] = None,
    `af`: Option[Double] = None,
    `an`: Option[Long] = None,
    `hom`: Option[Long] = None,
...
case class GNOMAD_EXOMES_2_1_1(
    `ac`: Option[Long] = None,
    `af`: Option[Double] = None,
    `an`: Option[Long] = None,
    `hom`: Option[Long] = None
