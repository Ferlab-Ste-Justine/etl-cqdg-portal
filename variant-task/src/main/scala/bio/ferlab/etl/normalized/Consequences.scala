...
case class Consequences(rc: RuntimeETLContext, studyId: String, owner: String, vcfPattern: String, referenceGenomePath: Option[String]) extends BaseConsequences(rc: RuntimeETLContext, annotationsColumn = csq, groupByLocus = true) {
