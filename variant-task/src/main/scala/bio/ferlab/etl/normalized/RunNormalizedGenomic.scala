...
object RunNormalizedGenomic {
  ...
  def snv(rc: RuntimeETLContext,
          ...
          @arg(name = "reference-genome-path", short = 'g', doc = "Reference Genome Path") referenceGenomePath: Option[String]): Unit = SNV(rc, studyId, owner, releaseId, vcfPattern, referenceGenomePath).run()
  ...
  def consequences(rc: RuntimeETLContext,
                   ...
                   @arg(name = "owner", short = 's', doc = "Owner") owner: String,
                   @arg(name = "vcf-pattern", short = 'v', doc = "VCF Pattern") vcfPattern: String,
                   @arg(name = "reference-genome-path", short = 'g', doc = "Reference Genome Path") referenceGenomePath: Option[String]): Unit = Consequences(rc, studyId, owner, vcfPattern, referenceGenomePath).run()
