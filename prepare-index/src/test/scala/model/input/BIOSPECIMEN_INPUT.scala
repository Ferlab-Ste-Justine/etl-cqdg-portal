...
case class BIOSPECIMEN_INPUT(
    ...
    `security`: String = "U",
    `biospecimen_tissue_source`: CODE_SYSTEM_DISPLAY_INPUT = CODE_SYSTEM_DISPLAY_INPUT(`code` = "NCIT:C12434"),
    `cancer_anatomic_location`: CODE_SYSTEM_INPUT_TEXT =
      CODE_SYSTEM_INPUT_TEXT(`code` = "NCIT:C12434", `text` = Some("location")),
    `tumor_histological_type`: CODE_SYSTEM_INPUT_TEXT = CODE_SYSTEM_INPUT_TEXT(
...
case class CODE_SYSTEM_DISPLAY_INPUT(
