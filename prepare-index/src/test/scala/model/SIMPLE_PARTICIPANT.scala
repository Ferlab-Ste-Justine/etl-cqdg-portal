...
case class SIMPLE_PARTICIPANT(
    ...
    `gender`: DEMOGRAPHICS =
      DEMOGRAPHICS(`code` = "Man", `collect_method` = CODEABLE(`code` = "Self-identified", `display` = null)),
    `sex`: String = "Male",
    `sex_at_birth`: DEMOGRAPHICS =
      DEMOGRAPHICS(`code` = "Male", `collect_method` = CODEABLE(`code` = "Clinician-recorded", `display` = null)),
    `race`: DEMOGRAPHICS =
