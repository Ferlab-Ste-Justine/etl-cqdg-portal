...
case class RESEARCHSTUDY(
                          ...
                          `access_limitations`: Seq[CODE_SYSTEM] = Seq(CODE_SYSTEM(`code` = "DUO:0000005", `display` = Some("General research use"))),
                          `access_requirements`: Seq[CODE_SYSTEM] = Seq(CODE_SYSTEM(`code` = "DUO:0000021", `display` = Some("Ethics approval required")), CODE_SYSTEM(`code` = "DUO:0000027", `display` = Some("Project specific restriction"))),
