...
object Publisher {
  ...
  /** Will generate the regex to fetch current (in alias) ElasticSearch indexes.
    * @param jobs
    *   Seq of clinical jobs (participant_centric, study_centric, ...) or variants (variant_centric, gene_centric, ...)
    * @param studies
    *   Seq of studies, only required for clinical jobs
    *
    * Assume the index of the format: Clinical jobs: "[JOB_TYPE]_[STUDY]_..." Variant jobs: "[JOB_TYPE]_..."
    *
  ...
  /** Will generate the regex to fetch desired ElasticSearch indexes.
    ...
    *   Seq of clinical jobs (participant_centric, study_centric, ...) or variants (variant_centric, gene_centric, ...)
    * @param releaseId
    *   Release id of clinical or variant run
    * @param studies
    *   Seq of studies, only required for clinical jobs
    *
    * Assume the index of the format: Clinical jobs: "[JOB_TYPE]_[STUDY]_[RELEASE_ID]" Variant jobs:
    * "[JOB_TYPE]_..._[RELEASE_ID]"
    */
  ...
  def retrieveIndexesFromRegex(regex: String, fromQuery: String)(esNodes: String, esPort: String)(implicit
  ...
  def updateAlias(alias: String, currentIndex: String, opType: String)(esNodes: String, esPort: String)(implicit
      esHttpClient: EsHttpClient
  ): Unit = {
