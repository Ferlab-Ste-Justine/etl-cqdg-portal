/** Generated by [[bio.ferlab.datalake.testutils.ClassGenerator]] on 2023-08-11T19:42:23.966397
  */
package models

case class NORMALIZED_RESEARCH_STUDY(
    `fhir_id`: String = "study1",
    ...
    `access_requirements`: Seq[ACCESS_REQUIREMENTS] = Seq(
      ACCESS_REQUIREMENTS(),
      ACCESS_REQUIREMENTS(`code` = "DUO:0000021"),
      ACCESS_REQUIREMENTS(`code` = "DUO:0000026")
    ),
...
case class ACCESS_AUTHORITY(`type`: String = "email", `value`: String = "jacques.michaud.med@ssss.gouv.qc.ca")

case class ACCESS_LIMITATIONS(`code`: String = "DUO:0000006", `display`: Option[String] = None)

case class ACCESS_REQUIREMENTS(`code`: String = "DUO:0000016", `display`: Option[String] = None)

case class DATA_SETS(`name`: String = "d1", `description`: String = "description 1")
