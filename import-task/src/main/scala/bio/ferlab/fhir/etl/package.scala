...
//  *********** CODE SYSTEMS **************
  ...
  // Patient
  val ETHNICITY_S_D = s"$SYSTEM_URL_CQDG/StructureDefinition/Patient/Ethnicity"
  val AGE_OF_DEATH_S_D = s"$SYSTEM_URL_CQDG/StructureDefinition/Patient/age-of-death"
  // ResearchStudy
  val ACCESS_LIMITATIONS_S_D = s"$SYSTEM_URL_CQDG/StructureDefinition/ResearchStudy/limitation"
  val ACCESS_REQUIREMENTS_S_D = s"$SYSTEM_URL_CQDG/StructureDefinition/ResearchStudy/requirement"
