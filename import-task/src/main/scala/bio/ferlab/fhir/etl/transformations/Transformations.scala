...
object Transformations {
    ...
    Custom(
      _.select("fhir_id", "study_id", "identifier", "extension", "meta")
        ...
        .withColumn(
          ...
          firstNonNull(filter(col("identifier"), col => col("use") === "secondary"))("value")
        )
        ...
        .withColumn(
          "sexAtBirthExt",
          firstNonNull(filter(col("extension"), col => col("url") === SEX_AT_BIRTH_S_D))("extension")
        )
  ...
  val taskMappings: List[Transformation] = List(
    Custom(
      _.select("fhir_id", "study_id", "output", "code", "for", "owner", "extension")
        .withColumn(
          "bio_informatic_analysis",
          filter(col("code")("coding"), col => col("system") === TASK_BIO_INFO)(0)("display")
        )
        ...
        .withColumn(
          "lab_aliquot_ids",
          filter(col("task_sample_ext")("extension"), col => col("url") === "labAliquotId")("valueString")
        )
        .withColumn(
          "ldm_sample_id",
          filter(col("task_sample_ext")("extension"), col => col("url") === "ldmSampleId")(0)("valueString")
        )
        ...
        .withColumn(
          "read_length",
          split(filter(col("seq_exp")("extension"), col => col("url") === "readLength")(0)("valueString"), ",")(0)
        )
        .withColumn(
          "is_paired_end",
          filter(col("seq_exp")("extension"), col => col("url") === "isPairedEnd")(0)("valueBoolean")
        )
        ...
        .withColumn(
          "sequencer_id",
          filter(col("seq_exp")("extension"), col => col("url") === "sequencerId")(0)("valueString")
        )
        .withColumn(
          "source",
          transform(
        ...
        .withColumn(
          ...
          transform(
            col("output"),
            col =>
              struct(col("type")("coding")(0)("code") as "data_type", col("valueReference")("reference") as "file_id")
          )
        )
    ),
  ...
  val listMappings: List[Transformation] = List(
    Custom(
      _.select("fhir_id", "study_id", "identifier", "title", "entry", "extension")
        ...
        .withColumn(
          ...
          firstNonNull(filter(col("extension"), col => col("url") === RESEARCH_PROGRAM_SD))("extension")
        )
        .withColumn("name_fr", filter(col("research_program_ext"), col => col("url") === "nameFR")(0)("valueString"))
        .withColumn(
          "description_fr",
          filter(col("research_program_ext"), col => col("url") === "descriptionFR")(0)("valueString")
        )
        .withColumn(
          "description_en",
          filter(col("research_program_ext"), col => col("url") === "descriptionEN")(0)("valueString")
        )
        .withColumn(
          "research_program_related_artifact_raw",
          filter(col("research_program_ext"), col => col("url") === RESEARCH_PROGRAM_RELATED_ARTIFACT_SD)(0)(
            "extension"
          )
        )
        .withColumn(
          ...
          struct(
            firstNonNull(filter(col("research_program_related_artifact_raw"), col => col("url") === "website"))(
              "valueUrl"
            ) as "website",
            firstNonNull(
              filter(col("research_program_related_artifact_raw"), col => col("url") === "citationStatement")
            )("valueString") as "citation_statement",
            firstNonNull(filter(col("research_program_related_artifact_raw"), col => col("url") === "logo"))(
              "valueUrl"
            ) as "logo_url"
          )
        )
        .withColumn(
          ...
          filter(col("research_program_ext"), col => col("url") === RESEARCH_PROGRAM_CONTACT_SD)
        )
        .withColumn(
          ...
          transform(
            ...
            contact =>
              struct(
                ...
                transform(
                  filter(contact("extension"), ext => ext("url") === "telecom")("valueContactPoint"),
        ...
        .withColumn(
          ...
          filter(col("research_program_ext"), col => col("url") === RESEARCH_PROGRAM_PARTNER_SD)
        )
        .withColumn(
  ...
  val biospecimenMappings: List[Transformation] = List(
    Custom {
      _.select("fhir_id", "extension", "identifier", "subject", "study_id", "type", "meta", "parent")
        ...
        .withColumn(
          ...
          transform(
            col("type")("coding"),
            col => struct(col("system") as "system", col("code") as "code", col("display") as "display")
          )(0)
        )
        .withColumn(
          "tumor_normal_designation",
          transform(
            filter(col("extension"), col => col("url") === TUMOR_NORMAL_DESIGNATION_S_D)(0)("valueCodeableConcept")(
              "coding"
            ),
  ...
  val sampleRegistrationMappings: List[Transformation] = List(
    Custom {
      _.select("identifier", "type", "subject", "parent", "study_id", "fhir_id")
        ...
        .withColumn(
          "parent",
          firstNonNull(transform(col("parent"), col => regexp_extract(col("reference"), specimenExtract, 1)))
        )
    },
  ...
  val observationCauseOfDeathMappings: List[Transformation] = List(
    Custom(
      _.select("study_id", "fhir_id", "code", "subject")
        .filter(
          array_contains(col("code")("coding")("system"), "https://fhir.cqdg.ferlab.bio/CodeSystem/cause-of-death")
        )
  ...
  val observationFamilyRelationshipMappings: List[Transformation] = List(
    Custom(
      _.select("study_id", "fhir_id", "code", "subject", "focus", "valueCodeableConcept", "category")
        ...
        .withColumn(
          ...
          firstNonNull(transform(col("focus"), col => regexp_extract(col("reference"), patientExtract, 1)))
        )
        .withColumn(
          "relationship_to_proband",
          firstNonNull(transform(col("valueCodeableConcept")("coding"), col => col("code")))
        )
  ...
  val conditionDiagnosisMappings: List[Transformation] = List(
    Custom(
      _.select("identifier", "code", "subject", "study_id", "fhir_id", "extension")
  ...
  val observationPhenotypeMappings: List[Transformation] = List(
    Custom(
      _.select("study_id", "fhir_id", "code", "valueCodeableConcept", "subject", "interpretation", "extension")
  ...
  val researchstudyMappings: List[Transformation] = List(
    Custom(
      _.select(
        ...
        .withColumn(
          "contact_names",
          transform(filter(col("contact"), col => col("name").isNotNull), col => col("name"))
        )
        .withColumn("contact_extensions", flatten(col("contact")("extension")))
        .withColumn(
          "contact_institutions",
          transform(
            filter(col("contact_extensions"), col => col("url") === CONTACT_INSTITUTIONS_SD),
            col => col("valueString")
          )
        )
        .withColumn(
          "contact_emails",
          transform(filter(col("contact_extensions"), col => col("url") === CONTACT_TYPE_SD), col => col("valueString"))
        )
        .withColumn(
          "website",
          transform(filter(col("relatedArtifact"), col => col("label") === "StudyWebsite"), col => col("url"))(0)
        )
        ...
        .withColumn(
          ...
          filter(col("expected_items")("extension"), col => col("url") === "expectedNumberParticipants")(0)(
            "valueInteger"
          )
        )
        .withColumn(
          "expected_number_biospecimens",
          filter(col("expected_items")("extension"), col => col("url") === "expectedNumberBiospecimens")(0)(
            "valueInteger"
          )
        )
        .withColumn(
          "expected_number_files",
          filter(col("expected_items")("extension"), col => col("url") === "expectedNumberFiles")(0)("valueInteger")
        )
        .withColumn(
          "restricted_number_participants",
          filter(col("expected_items")("extension"), col => col("url") === "restrictedNumberParticipants")(0)(
            "valueInteger"
          )
        )
        .withColumn(
          "restricted_number_biospecimens",
          filter(col("expected_items")("extension"), col => col("url") === "restrictedNumberBiospecimens")(0)(
            "valueInteger"
          )
        )
        .withColumn(
          "restricted_number_files",
          filter(col("expected_items")("extension"), col => col("url") === "restrictedNumberFiles")(0)("valueInteger")
        )
        .withColumn(
          "principal_investigators",
          transform(
            firstNonNull(filter(col("extension"), col => col("url") === PRINCIPAL_INVESTIGATORS_SD))("extension"),
            col => col("valueString")
          )
        )
        .withColumn(
          "data_categories",
          transform(
            filter(col("extension"), col => col("url") === DATA_CATEGORY_SD)("valueCoding"),
            col =>
              when(
                isnull(col("display")),
                col("code")
        ...
        .withColumn(
          "study_designs",
          transform(
            filter(col("extension"), col => col("url") === STUDY_DESIGN_SD)("valueCoding"),
            col =>
              when(
                isnull(col("display")),
                col("code")
        ...
        .withColumn(
          ...
          transform(
            filter(col("extension"), col => col("url") === DATA_COLLECTION_METHODS_DS)("valueCoding"),
            col =>
              when(
                isnull(col("display")),
                col("code")
        ...
        .withColumn(
          "access_requirements",
          transform(
            filter(col("extension"), col => col("url") === ACCESS_REQUIREMENTS_S_D)(0)("valueCodeableConcept")(
              "coding"
            ),
            col => struct(col("code") as "code", col("display") as "display")
          )
        ...
        .withColumn(
          "population",
          filter(col("extension"), col => col("url") === POPULATION_S_D)(0)("valueCoding")("code")
        )
        .withColumn(
          "study_version",
          regexp_extract(
            filter(col("meta")("tag"), col => col("code").contains("study_version"))(0)("code"),
            versionExtract,
            1
          )
        )
        ...
        .withColumn(
          ...
          firstNonNull(
            transform(
              ...
              col => when(lower(col("valueBoolean")) === "true", lit("R")).otherwise(lit("U"))
            )
          )
        )
    ),
  ...
  val documentreferenceMappings: List[Transformation] = List(
    Custom { input =>
      val columns =
        Array("id", "type", "category", "subject", "content", "context", "study_id", "fhir_id", "meta", "relatesTo")
      val df = input
        .select(columns.head, columns.tail: _*)
        .withColumn("participant_id", regexp_extract(col("subject")("reference"), patientExtract, 1))
        .withColumn(
          "biospecimen_reference",
          transform(col("context")("related"), col => regexp_extract(col("reference"), specimenExtract, 1))
        )
        .withColumn("data_type_cs", filter(col("type")("coding"), col => col("system") === DOCUMENT_DATA_TYPE)(0))
        .withColumn(
          "data_type",
          when(isnull(col("data_type_cs")("display")), col("data_type_cs")("code"))
        ...
        .withColumn(
          "data_category",
          when(isnull(col("data_category_cs")("display")), col("data_category_cs")("code"))
  ...
  val groupMappings: List[Transformation] = List(
    Custom(
      _.select("study_id", "fhir_id", "code", "member", "identifier")
        ...
        .withColumn(
          "family_members",
          transform(col("member"), col => regexp_extract(col("entity")("reference"), patientExtract, 1))
        )
